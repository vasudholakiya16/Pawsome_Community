...
import 'package:pass_app_ultron_techonology/controller/whichList_controller.dart';
...
class ChickItemDetails extends StatelessWidget {
  final String? title;
  final dynamic data;

  ChickItemDetails({super.key, required this.title, this.data});
