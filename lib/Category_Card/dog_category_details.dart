...
class DogDogCategoryDetail extends StatefulWidget {
  final String? title;

  const DogDogCategoryDetail({Key? key, required this.title}) : super(key: key);

  @override
  State<DogDogCategoryDetail> createState() => _DogDogCategoryDetailState();
}

class _DogDogCategoryDetailState extends State<DogDogCategoryDetail> {
  @override
  void initState() {
