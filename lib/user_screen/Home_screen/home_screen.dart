            ...
            Padding(
              ...
              child: Row(
                children: [
                  GestureDetector(
                    onTap: () {
                      Get.to(() => const DogCategoryScreen(
                            title: 'Category of Dog',
                          ));

                      print('Dog category clicked');
                    },
                    child: categoryScreen(
                        'assets/images/dog0.png', 'Dog', context),
                  ),
                  GestureDetector(
                    onTap: () {
                      Get.to(() => const CatCategoryScreen(
                            title: 'Category of Cat',
                          ));
                      print('Cat category clicked');
                    },
                    child: categoryScreen(
                        'assets/images/cat_face_main_page.png', 'Cat', context),
                  ),
                  GestureDetector(
                    onTap: () {
                      Get.to(() => const FishCategoryScreen(
                            title: 'Category of fish',
                          ));
                      // FishCategoryScreen
                      print('Fish category clicked');
                    },
                    child: categoryScreen(
                        'assets/images/fish_main_page.png', 'Fish', context),
                  ),
                  GestureDetector(
                    onTap: () {
                      Get.to(() => const ChickCategoryScreen(
                            title: 'Category of Chick',
                          ));
                      // ChickCategoryScreen
                      print('Chick category clicked');
                    },
                    child: categoryScreen(
                        'assets/images/chick_main_page.png', 'Chick', context),
                  ),
                ],
              ),
            ),
