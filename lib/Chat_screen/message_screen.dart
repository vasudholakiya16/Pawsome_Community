...
class _MessageCardState extends State<MessageCard> {
  ...
  Widget build(BuildContext context) {
    // Initialize mq with MediaQuery size
  ...
  Widget _blueMessage() {
    ...
    return Row(
      ...
      children: [
        ...
        // Assuming widget.message.sent is a valid timestamp represented as an int
        Text(
          MyDateUtil.getFormattedTime(
            context: context,
            time: widget.message.sent,
            timestamp: int.parse(widget.message.sent), // Convert String to int
          ),
          ...
          return ListView(
            ...
            children: [
              ...
              if (widget.message.type == Type.text && isMe)
                _OptionItem(
                    icon: const Icon(Icons.edit, color:Color(0xFFCA7867) , size: 26),
                    name: 'Edit Message',
                    onTap: () {
                      //for hiding bottom sheet
                      Navigator.pop(context);
